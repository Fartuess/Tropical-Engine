...
Model* CreatePlane(QString name, float sizeX, float sizeY, int subdivisionsX, int subdivisionsY)
{
	///TODO: implement it.
	return nullptr;
}

Model* CreateBox(QString name, float sizeX, float sizeY, float sizeZ, int subdivisionsX, int subdivisionsY, int subdivisionsZ)
{
	///TODO: implement it.
	return nullptr;
}

Model* CreateBox(QString name, glm::vec3 size, int subdivisionsX, int subdivisionsY, int subdivisionsZ)
{
	///TODO: implement it.
	return nullptr;
}
...
Model* CreateCylinder(QString name, float radius, float height, int subdivisiomsAxis, int subdivisionsHeight)
{
	///TODO: implement it.
	return nullptr;
}

Model* CreateCone(QString name, float radius, float height, int subdivisionsAxis, int subdivisionsHeight)
{
	///TODO: implement it.
	return nullptr;
}

Model* CreateSphere(QString name, float radius, int subdivisionsAxis, int subdivisionsHeight)
{
	///TODO: implement it.
	return nullptr;
}

Model* CrateTorus(QString name, float radius, float segmentRadius, int subdivisionsAxis, int subdivisionsHeight)
{
	///TODO: implement it.
	return nullptr;
}
