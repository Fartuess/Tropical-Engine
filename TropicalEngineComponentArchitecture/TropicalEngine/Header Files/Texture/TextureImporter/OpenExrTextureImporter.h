...
namespace TropicalEngine
{
	...
	/**
	  * \brief Class for importing OpenExr hdr textures.
	  *
	  * Supports exr high dynamic range format..
	  */
	#pragma endregion
	...
	public:
		#pragma region documentation
		/**
		  * \brief Constructor. Registers this importer as importer for exr format.
		  */
		#pragma endregion
